...
ln -sf /dev/stdout nohup.out
/usr/bin/nohup java -jar /opt/exhibitor/exhibitor.jar --port 8181 --defaultconfig /opt/exhibitor/defaults.conf ${BACKUP_CONFIG} ${HTTP_PROXY} --hostname ${HOSTNAME} ${SECURITY} &
